Adicionei a base de dados completa (com alguns registos) para usares corres uma vez sem os coments do landing
(para fazer as alterações à base de dados) depois voltas a dar comment
